...
I'm Francis, COO, I run the operations on the backend so your experience here runs the way it's supposed to. I also help with the DM Setting side of the business.
...
---
🚨 One more thing — reply here with the **email address you purchased with** so we can get your account linked up.`;
}
